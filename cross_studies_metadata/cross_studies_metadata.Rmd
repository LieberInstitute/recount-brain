...
notes <- read.csv("https://raw.githubusercontent.com/LieberInstitute/recount-brain/master/SupplementaryTable4.csv",
    header= T, as.is = T)
...
write.csv(recount_brain, file = 'recount_brain_v2.csv', quote = TRUE,
    row.names = FALSE)
