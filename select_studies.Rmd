...
If you want to reproduce this document, you will need the following R packages installed. It's best if you install R 3.5 from [CRAN](https://cran.r-project.org/) and maybe even [RStudio](https://www.rstudio.com/).
