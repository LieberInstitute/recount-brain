...
table_content <- lapply(table_files, read.csv, header = TRUE, stringsAsFactors = FALSE, na.strings = c('NA', ''))
...
table(recount_brain$disease[recount_brain$present_in_recount & recount_brain$age_units == 'Years'], useNA = 'ifany')
```
