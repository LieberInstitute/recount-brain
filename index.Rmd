...
56. `broadmann_ontology`: URL for the Broadmann region ontology. See the [`recount_brain_ontologies`](cross_studies_metadata/recount_brain_ontologies.html) file for how this information was added.
57. `disease_ontology`: URL for the disease ontology.
58. `tissue`: tissue in text derived from the `tissue_ontology`.
59. `tissue_ontology`: URL for the tissue ontology.
